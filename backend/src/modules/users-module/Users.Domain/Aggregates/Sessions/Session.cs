...
using Users.Domain.Aggregates.Sessions.Events;

namespace Users.Domain.Aggregates.Sessions;
...
public sealed class Session : AggregateRoot<Guid>
{
        ...
        bool isCurrent = false)
    {
        ...
        session.RegisterDomainEvent(new SessionCreatedDomainEvent(session.Id, userId, deviceType, ipAddress));
    ...
    public void Revoke(string? reason = null)
    {
        ...
        RegisterDomainEvent(new SessionRevokedDomainEvent(Id, UserId, reason));
    }
