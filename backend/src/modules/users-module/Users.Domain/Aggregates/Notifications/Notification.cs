...
using Users.Domain.Aggregates.Notifications.Events;

namespace Users.Domain.Aggregates.Notifications;
...
public sealed class Notification : AggregateRoot<Guid>
{
    ...
    public void MarkAsRead()
    {
        ...
        RegisterDomainEvent(new NotificationReadDomainEvent(Id, UserId));
    }
