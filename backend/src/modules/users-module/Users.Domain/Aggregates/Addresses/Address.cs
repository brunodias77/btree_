...
using Users.Domain.Aggregates.Addresses.Events;
...
public sealed class Address : AggregateRoot<Guid>
{
        ...
        bool isBillingAddress = false)
    {
        ...
        address.RegisterDomainEvent(new AddressCreatedDomainEvent(address.Id, userId));
        ...
        bool? isBillingAddress)
    {
        ...
        RegisterDomainEvent(new AddressUpdatedDomainEvent(Id, UserId));
    }
    ...
    public void SetAsDefault()
    {
        ...
        RegisterDomainEvent(new AddressSetAsDefaultDomainEvent(Id, UserId));
    }
    ...
    public void SoftDelete()
    {
        ...
        RegisterDomainEvent(new AddressDeletedDomainEvent(Id, UserId));
    }
