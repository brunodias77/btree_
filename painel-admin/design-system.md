...
O design system da **btree\_** é uma fusão de brutalismo digital e estética streetwear. Priorizamos o alto contraste, tipografia ousada, cantos retos (sharp) e micro-interações táteis. A interface deve parecer uma ferramenta de terminal moderna: funcional, rápida e crua.
...
Para implementar este sistema rapidamente, adicione estas configurações de design tokens da v4 do tailwindcss ao seu `styles.css`:
